package com.noondunge.www.eximplicitintent;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchBtn = (Button)findViewById(R.id.searh_button);
        ...
        callBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Snackbar.make(v, "해당 번호로 전화를 거시겠습니까?", Snackbar.LENGTH_SHORT)
...
//                        }
        ...
        searchBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Snackbar.make(v, "해당 키워드로 검색하시겠습니까?", Snackbar.LENGTH_SHORT)
                        .setAction("OK", new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.co.kr/search?q="+searchInput+"&oq="+searchInput+"&ie=UTF-8"));
                                startActivity(intent);
                            }
                        }).show();
            }
